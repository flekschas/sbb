...
var sbbController = angular.module('sbb.controllers', []);

sbbController.controller('ViewCtrl', [
    '$scope',
    '$routeParams',
    '$filter',
    '$location',
    ...
    function(
        ...
        $http
            ...
            .success(function (data) {
                ...
                if ($scope.data.zoomOutLevels.length) {
                    if (!$scope.data.zoomOutLevels[0]['view']) {
                        var gender = SBBStorage.get('gender', true);
                        if (!gender) {
                            if (Math.random() > 0.5) {
                                gender = 'male';
                            } else {
...
sbbController.controller('AboutCtrl', [
    '$scope',
    '$location',
    '$window',
    'News',
