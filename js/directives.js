...
var sbbDirectives = angular.module('sbb.directives', []);

sbbDirectives.directive('ngRepeatFinishRender',
  ['$timeout', 'News',
...
sbbDirectives.directive('globalEvents',
  ['News',
  function(News) {
...
sbbDirectives.directive('scroll',
  ['News',
  function(News) {
    return function(scope, element) {
...
sbbDirectives.directive('sbbChosen',
  ['$compile', '$sce', '$timeout', '$location', 'StringWidth', 'News', 'settings',
  function($compile, $sce, $timeout, $location, StringWidth, News, settings) {
    return {
      restrict: 'E',
      scope: {
        data: '=',
...
sbbDirectives.directive('about',
  ['$location', 'News', 'settings',
  function($location, News, settings) {
...
sbbDirectives.directive('bookmarks',
  ['$location', 'News', 'SBBStorage', 'settings',
  function($location, News, SBBStorage, settings) {
    return {
      restrict: 'C',
...
sbbDirectives.directive('help', ['News', 'SBBStorage', 'settings',
  function(News, SBBStorage, settings) {
    // Activate the help
    return {
      restrict: 'C',
...
sbbDirectives.directive('species', ['$location', 'News', 'SBBStorage', 'settings',
  function($location, News, SBBStorage, settings) {
    return {
      restrict: 'C',
...
sbbDirectives.directive('gender', ['SBBStorage', function(SBBStorage) {
...
sbbDirectives.directive('devStage', ['News', 'settings',
...
sbbDirectives.directive('zoom', ['SBBStorage', 'News', 'settings',
  function(SBBStorage, News, settings) {
      ...
      link: function(scope, element) {
        ...
        scope.goto = function(level) {
          ...
          if (level === 'body' && scope.species == 'human') {
            gender = SBBStorage.get('gender', true);
            if (!gender) {
              if (Math.random() > 0.5) {
                gender = 'male';
              } else {
...
sbbDirectives.directive('raphael',
...
sbbDirectives.directive('units', ['$timeout', 'News',
  function($timeout, News) {
...
sbbDirectives.directive('accordion', ['News',
  function(News) {
...
sbbDirectives.directive('searchResultsCenter', [
  function() {
    return function(scope, element) {
...
sbbDirectives.directive('sliderImg', ['News', '$timeout', '$http',
  function(News, $timeout, $http) {
    return {
      restrict: 'E',
      scope: {
        picture: '@'
...
sbbDirectives.directive('horizontalSlider', ['News',
  function(News) {
...
sbbDirectives.directive('helpMessage', [
  function() {
    return {
      restrict: 'A',
      scope: {
